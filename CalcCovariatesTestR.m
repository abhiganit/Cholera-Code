function [X] = CalcCovariatesTestR(tA,DB,DA,Ctv,K,n,tau,maxtau,CF,WPIN,FPIN,Mt,Wheatt,Dieselt,KP,Rtv,RF,r0,WI,Pop,CI,DAR,w)
...
% Targeted Attacks
for ii=1:maxtau
    X(ii,:,:)=WPIN(:,(1+maxtau-tau(ii)):(end-tau(ii))).*(ImpactAttack(tA,DB(1),DA(1),tau(ii),maxtau)).*Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))./(Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))+DAR.*CI(:,(1+maxtau-tau(ii)):(end-tau(ii))));
end
% General conflict
for ii=(maxtau+1):2*maxtau
    X(ii,:,:)=(w.*WPIN(:,(1+maxtau-tau(ii)):(end-tau(ii)))+(1-w).*FPIN(:,(1+maxtau-tau(ii)):(end-tau(ii)))).*(ImpactConflict(Ctv(:,(1+maxtau-tau(ii)):(end-tau(ii))),K(1),CF(1))).*Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))./(Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))+DAR.*CI(:,(1+maxtau-tau(ii)):(end-tau(ii))));
end
%Shelling and air attacks
for ii=(2.*maxtau+1):3*maxtau
    X(ii,:,:)=(w.*WPIN(:,(1+maxtau-tau(ii)):(end-tau(ii)))+(1-w).*FPIN(:,(1+maxtau-tau(ii)):(end-tau(ii)))).*(ImpactConflict(Mt(:,(1+maxtau-tau(ii)):(end-tau(ii))),K(2),CF(2))).*Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))./(Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))+DAR.*CI(:,(1+maxtau-tau(ii)):(end-tau(ii))));
end
% Diesel prices
for ii=(3.*maxtau+1):4*maxtau
    X(ii,:,:)=(w.*WPIN(:,(1+maxtau-tau(ii)):(end-tau(ii)))+(1-w).*FPIN(:,(1+maxtau-tau(ii)):(end-tau(ii)))).*max(Dieselt(:,(1+maxtau-tau(ii)):(end-tau(ii)))-KP(1),0).*Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))./(Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))+DAR.*CI(:,(1+maxtau-tau(ii)):(end-tau(ii))));
end

% Wheat prices
for ii=(4.*maxtau+1):5*maxtau
    X(ii,:,:)=FPIN(:,(1+maxtau-tau(ii)):(end-tau(ii))).*max(Wheatt(:,(1+maxtau-tau(ii)):(end-tau(ii)))-KP(2),0).*Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))./(Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))+DAR.*CI(:,(1+maxtau-tau(ii)):(end-tau(ii))));
end

%Rainfall
for ii=(5.*maxtau+1):6*maxtau
    X(ii,:,:)=WPIN(:,(1+maxtau-tau(ii)):(end-tau(ii))).*(ImpactRainfall(Rtv(:,(1+maxtau-tau(ii)):(end-tau(ii))),RF,r0)).*Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))./(Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))+DAR.*CI(:,(1+maxtau-tau(ii)):(end-tau(ii))));
end

%Incidence per capita
for ii=(6.*maxtau+1):7*maxtau
    X(ii,:,:)=(w.*WPIN(:,(1+maxtau-tau(ii)):(end-tau(ii)))+(1-w).*FPIN(:,(1+maxtau-tau(ii)):(end-tau(ii)))).*Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))./(Pop(:,(1+maxtau-tau(ii)):(end-tau(ii)))+DAR.*CI(:,(1+maxtau-tau(ii)):(end-tau(ii))));
end
end
