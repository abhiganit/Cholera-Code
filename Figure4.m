...
%     'Color','none');
% 
% CIPC= ((CI(GNZI(indexs),end))./PopS(GNZI(indexs),1)).*10000;
% line(CIPC,[1:21],'Parent',ax2,'Color',[0.5 0.5 0.5],'LineWidth',2)
% ylim([0.5 21.5]);
% xlim([10^0.5 10^3.5])
% set(ax2,'LineWidth',2,'tickdir','out','XScale','log','YTick',[1:21],'YTickLabel',{},'Fontsize',16);
% ax2.XColor=[0.5 0.5 0.5];
% xlabel('Cumulative incidence per capita','Fontsize',18,'Color',[0.5 0.5 0.5]);
