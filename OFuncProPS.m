function [F]= OFuncProPS(x,CF,WI,tA,Ctv,XU,maxtau,RC,WPIN,FPIN,Mt,Wheatt,Dieselt,V1,V2,Rtv,RF)
...
[xf] = ExpandPar(x,XU,CF,RF,1);
[~,beta,tau,DB,DA,K,n,KP,KV,dV,r,r0,rm]=RetParameterPS(xf,XU,CF,RF);
