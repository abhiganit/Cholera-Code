function [F]= OFuncProPS(x,CF,RF,RIF,WI,tA,Ctv,Rtv,XU,maxtau,P,RC,H,WPIN,FPIN,Mt,Wheatt,Dieselt,V1,V2)
...
[xf] = ExpandPar(x,XU,1);
[~,beta,tau,DB,DA,DBE,DAE,K,n,rl,rh,KP,a,KV,dV]=RetParameterPS(xf,XU,CF);
