...
indxv=[5:8 13:16 25:28; 5:8 13:16 25:28; 5:8 13:16 25:28; 9:12 13:16 25:28; 9:12 13:16 25:28; 9:12 13:16 25:28; 5:8 17:20 25:28; 5:8 17:20 25:28; 5:8 17:20 25:28; 9:12 17:20 25:28; 9:12 17:20 25:28; 9:12 17:20 25:28;];
...
for mm=1:length(ModelBase)
    ...
    load(['Fit-Vaccination-IncidenceperCapita-' ModelBase{mm} '-CalibratedDAR.mat'],'par','XU','CF','maxtau','DAR','RF')
    [k,~,tau,~,~,~,~,~,KV,dV,r0,~,w]=RetParameterGA(par,XU,CF,maxtau);
    % Load Coefficient for conflict to see if there is a significinat
    % relationship
    load(['Fit-Vaccination-IncidenceperCapita-' CovariateConflict{mm} '-CalibratedDAR.mat'],'par','XU','CF','maxtau','RF')
    [~,beta,~,DB,DA,K,n,~,~,~,~,~,~]=RetParameterGA(par,XU,CF,maxtau);
    % Load the parameters for the prices    
    load(['Fit-Vaccination-IncidenceperCapita-' CovariatePrice{mm} '-CalibratedDAR.mat'],'par','XU','CF','maxtau','RF')
