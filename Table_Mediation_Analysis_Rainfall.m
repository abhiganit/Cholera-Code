clear;
load('Mediation_Analysis_Rainfall.mat');
...
for ii=1:length(betaz)
 ...
 writetable(T,'Mediation_Correlation_Rainfall.csv','Delimiter',',');
...
T=table(ModelBase,CovariateConflict,betaone,betatwo,betathree,betafour);
 ...
 writetable(T,'Mediation_Conflict_Coefficients_Rainfall.csv','Delimiter',',');
...
T=table(ModelBase,CovariatePrice,CovariateConflict,betaone,betatwo,betathree,betafour);
 ...
 writetable(T,'Mediation_Conflict_Comodity_Coefficients_Rainfall.csv','Delimiter',',');
 ...
 writetable(T,'Mediation_Effect_Rainfall.csv','Delimiter',',');