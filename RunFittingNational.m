...
problem = createOptimProblem('lsqnonlin','objective',@(x)OFunc(x,WI,tA,Ctv,Rtv,XU,tau,maxtau,AF,CF,RF),'x0',log10(rand(12,1)),'lb',lb,'ub',ub,'Aineq',[],'bineq',[],'Aeq',[],'beq',[],'options',opts);
