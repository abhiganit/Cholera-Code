function [par,fvalfit]=ProFittingDistrict(XU,CF,RF,pars)
...
[lb,ub,lbps,ubps,IntC,parst(mm,:)] = BoundsFittingD(XU,pars(mm,:),CF,maxtau);
end
...
options = optimoptions('ga','MaxGenerations',10^4,'FunctionTolerance',10^(-10),'InitialPopulationMatrix',parst,'Display','off','PlotFcn', @gaplotbestf,'HybridFcn',{@patternsearch,optionsps}); %
