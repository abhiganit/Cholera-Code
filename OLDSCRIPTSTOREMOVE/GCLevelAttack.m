function Ct= GCLevelAttack(C,S,NW)
% Ct= GCLevelAttack(C,S,NW) constructs a matrix of the of cumulative
% conflict/attacks agonf the areas over time
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Input
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
f=find(C(:,1)<1); % Find the events that have happened before the reported cases of cholera (indicated by index one)
C(f,1)=1;
