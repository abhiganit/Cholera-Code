function [WI,Ctv,tA,Rtv,Mt,P,RC,H,WPINm,FPINm,Dieselt,Wheatt,VT1,VT2,GNZI,GV,maxtau,PopS,CI] = LoadYemenCountryData
...
load('Precipitation_Yemen.mat'); % the perceipatiatino data for the differetn areas %Load the rainfall for the projection
...
Diesel=mean(Diesel(Diesel>0),2);
Wheat=mean(Wheat(Wheat>0),2);
