function [F]= OFuncProGAGLevel(x,CF,WI,tA,Ctv,XU,maxtau,WPIN,FPIN,Mt,Wheatt,Dieselt,V1,V2,Rtv,RF,Pop,CI)
...
F=sum((FF.^2),2); % convert the matrix into a vector for the use of lsqnonlin
end
