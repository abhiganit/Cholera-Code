function [XUr,RSSr,CVEr,parr,kr,par] = ForwardSelectionMulti(XU,RSS,k,atest,PDS,pars)
...
% par - return future staring poitns 
...
for ii=1:NMR
    ...
    [par(ii,:),RSSv(ii),CVE(ii)] = ProFittingMGA(XUm(ii,:),PDS,pars);
