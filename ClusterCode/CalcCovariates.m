...
WPt=ImpactConflict(Ctv(:,(1+maxtau-tau(11)):(end-tau(11))),K,n,CF).*ImpactRainfall(Rtv(:,(1+maxtau-tau(11)):(end-tau(11))),RF,rh); %Product of incidence and conflict
WPIt=ImpactAttack(tA,DB,DA,tau(12),maxtau).*ImpactRainfall(Rtv(:,(1+maxtau-tau(12)):(end-tau(12))),RF,rh); % Product of incidence and attacks 
