...
WheatIt=FPIN(:,(1+maxtau-tau(16)):(end-tau(16))).*ImpactRainfall(Wheatt(:,(1+maxtau-tau(16)):(end-tau(16))),1,mln(1)).*WI(:,(1+maxtau-tau(16)):(end-tau(16))); % We can use the impact rainf all function for the threshold of the price
DieselIt=FPIN(:,(1+maxtau-tau(17)):(end-tau(17))).*ImpactRainfall(Dieselt(:,(1+maxtau-tau(17)):(end-tau(17))),1,mln(2)).*WI(:,(1+maxtau-tau(17)):(end-tau(17))); % We can use the impact rainf all function for the threshold of the price
WasHDieselIt=WPIN(:,(1+maxtau-tau(18)):(end-tau(18))).*ImpactRainfall(Dieselt(:,(1+maxtau-tau(18)):(end-tau(18))),1,mln(3)).*WI(:,(1+maxtau-tau(18)):(end-tau(18))); % We can use the impact rainf all function for the threshold of the price
