...
MSE=OFuncProGAGLevel(pars,WI(GNZI,1:NWF),tA(GNZI,1:NWF),Ctv(GNZI,1:NWF),XU,maxtau,WPIN(GNZI,1:NWF),FPIN(GNZI,1:NWF),Mt(GNZI,1:NWF),Wheatt(GNZI,1:NWF),Dieselt(GNZI,1:NWF),V1(GNZI,1:NWF),V2(GNZI,1:NWF),Rtv(GNZI,1:NWF),Temptv(GNZI,1:NWF),PopS(GNZI,1:NWF),CI(GNZI,1:NWF));
...
load('Fit-Vaccination-IncidenceperCapita-Conflict-Shellings-Diesel-Rain-CalibratedDAR.mat');
[lb,ub,IntC,pars] = BoundsFitting(XU,par,maxtau);
CVE=OFuncProGAGLevel(pars,WI(GNZI,1:NW),tA(GNZI,1:NW),Ctv(GNZI,1:NW),XU,maxtau,WPIN(GNZI,1:NW),FPIN(GNZI,1:NW),Mt(GNZI,1:NW),Wheatt(GNZI,1:NW),Dieselt(GNZI,1:NW),V1(GNZI,1:NW),V2(GNZI,1:NW),Rtv(GNZI,1:NW),Temptv(GNZI,1:NW),PopS(GNZI,1:NW),CI(GNZI,1:NW));
