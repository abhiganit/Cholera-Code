function [F]= OFuncPro_sigma(x,par,WI,tA,Ctv,XU,maxtau,WPIN,FPIN,Mt,Wheatt,Dieselt,V1,V2,Rtv,Temptv,Pop,CI)
...
[~,beta,tau,DB,DA,K,n,KP,KV,dV,r0,temp_0,DAR,w,~]=RetParameterGA(par,XU,maxtau);
sigma_w=10.^x;
